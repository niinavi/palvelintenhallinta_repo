...
C) In this assignment I practiced command "git reset --hard". I made some changes into the files. I didn't commit them but with this command I removed all the changes I had made and resetted my repository to match the repository that is in Github.
